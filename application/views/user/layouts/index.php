            ...
            <ul class="navbar-nav ml-auto"> 
                <?php if ( is_user_logged_in() ) { ?>  
                    <li class="navbar-item">
                        <a class="nav-link" href="<?php echo site_url('item') ?>">Items</a>
                    </li>
                    <li class="navbar-item"><a class="nav-link" href="<?php echo site_url() ?>"><?php echo get_loggedin_info('username'); ?></a></li>
