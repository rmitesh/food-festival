		...
		<div class="col-lg-8">
		    <div class="container-fluid">
		    	<div class="d-flex justify-content-between">
		    		<h4>Manage Menu</h4>
    				<a href="<?php echo base_url('item/create') ?>" class="btn btn-primary">New Item</a>
		    	</div>
				<hr class="bg-dark" />
				<div class="row">
					<div class="col-lg-12">
								...
								<tbody>
									<?php if ( !empty( $items ) ) { ?>
										<?php foreach ( $items as $item ) { ?>
											<tr>
												<td class="align-middle"><?php echo $item['category_name'] ?></td>
												<td class="align-middle"><?php echo $item['name'] ?></td>
												<td class="align-middle"><?php echo '&#8377; ' . $item['price'] ?></td>
												<td width="15%">
													<div class="">
														<a href="<?php echo base_url( 'item/' . $item['id'] . '/edit' ) ?>" class="btn btn-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
															  	<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
															  	<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
															</svg>
														</a>
														<a href="<?php echo base_url( 'item/' . $item['id'] . '/destory' ) ?>" class="btn btn-danger delete-item">
					...
					<div class="col-lg-12">
						<form method="post" class="col-12 p-0 pt-2" autocomplete="off">
							<div class="form-group">
								...
								<input type="text" id="stall_name" name="stall_name" placeholder="Stall Name" class="form-control" value="<?php echo $stall_name; ?>" />
							</div>
							<div class="form-group">
  	...
  	<div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    	<div class="modal-content">
	      	...
	      	<div class="modal-body text-center">
	        	<img src="<?php echo $stall_url ?>" alt="QR Code" width="250px" height="250px" class="img img-thumbnail border-primary" />
	      	</div>
